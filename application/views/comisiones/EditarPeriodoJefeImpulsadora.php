									...
									if(!$impulsadoras){
										...
										foreach ($impulsadoras as $key) {
											echo "<tr>
												...
												<td>".$key["Apellidos"]."</td>												
												<td class='center'>
													<a href='javascript:void(0)' style='margin-right:4px;' onclick='editar(".'"'.$key["IdUsuario"].'","'.$key["ValorImpulsadora"].'","'.$key["Nombre"].'","'.$encabezadoPeriodo[0]["IdPeriodo"].'"'.")'
...
<div class="modal fade" id="modalEditar" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title font-weight-bold"  id="exampleModalLabel">Asignar comision a jefe de impulsadora</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
