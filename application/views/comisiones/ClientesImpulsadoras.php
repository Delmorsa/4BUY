									...
									if(!$impulsadoras){
										...
										foreach ($impulsadoras as $key) {
											echo "<tr>												
												...
												<td></td>
												<td class='center'>
													<a href='javascript:void(0)' style='margin-right:4px;' onclick='editar(".'"'.$key["IdUsuario"].'","'.$key["Nombre"].'"'.")'
...
<div class="modal fade" id="modalEditar" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title font-weight-bold"  id="exampleModalLabel">Asignar clientes a impulsadora</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">				
				<label class="col-md-3 control-label" for="thisid">Clientes:</label>
				...
				<button type="button" id="btnAddRuta" class="btn btn-primary">Agregar cliente a impulsadora</button>
